        ...
        while player <= players:
            while True:
                ...
                if HIT.lower() == 'yes':
                    ...
                    print(self.Player, self.Diler)
                    print([int(c[0]) if c[0].isdigit() else (10 if '10' or 'J' or 'Q' or 'K' in c else 11) for c in self.Player], [int(c[0]) if c[0].isdigit() else (10 if '10' or 'J' or 'Q' or 'K' in c else 11) for c in self.Diler])
